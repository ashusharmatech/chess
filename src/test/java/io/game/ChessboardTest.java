...
public class ChessboardTest {
    ...
    public void whenKingAtCorner() {
        ...
        assertThat(nextPositions, Matchers.hasSize(3));
    ...
    public void whenKingAtEdge() {
        ...
        assertThat(nextPositions, Matchers.hasSize(5));
    ...
    public void whenPawnIsInCenter() {
        ...
        assertThat(nextPositions, Matchers.hasSize(1));
    ...
    public void whenPawnAtTop() {
        ...
        assertThat(nextPositions, Matchers.is(Matchers.empty()));
    }
    ...
    public void whenHorseAtEdge() {
        ...
        assertThat(nextPositions, Matchers.hasSize(4));
    ...
    public void whenHorseHas6ValidMoves() {
        ...
        assertThat(nextPositions, Matchers.hasSize(6));
    ...
    public void whenRookHas4ValidDirections() {
        ...
        assertThat(nextPositions, Matchers.hasSize(14));
    ...
    public void whenBishopHas4DirectionsToMove() {
        ...
        assertThat(nextPositions, Matchers.hasSize(13));
    ...
    public void whenBishopAtEdge() {
        ...
        assertThat(nextPositions, Matchers.hasSize(7));
    ...
    public void whenQueenHasAllDirectionsToMove() {
        ...
        assertThat(nextPositions, Matchers.hasSize(27));
    ...
    public void whenQueenAtEdge() {
        ...
        assertThat(nextPositions, Matchers.hasSize(21));
    ...
    @Test
    @DisplayName("When Invalid input position is given. expected Fail")
    public void whenInvalidInputPositionThenShouldFail() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput(null));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput(""));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("A"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("AA"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("1"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("1A"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("11"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("A2A"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("A2A"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("A0"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("Z2"));
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parseInput("A9"));
    }


    @Test
    @DisplayName("When valid piece is given. expected Ok")
    public void whenValidInputPieceThenShouldReturnObject() {
        assertEquals(PieceType.KING.create().getClass(), Chessboard.parsePiece("King").getClass());
        assertEquals(PieceType.QUEEN.create().getClass(), Chessboard.parsePiece("Queen").getClass());
        assertEquals(PieceType.ROOK.create().getClass(), Chessboard.parsePiece("Rook").getClass());
        assertEquals(PieceType.HORSE.create().getClass(), Chessboard.parsePiece("Horse").getClass());
        assertEquals(PieceType.BISHOP.create().getClass(), Chessboard.parsePiece("Bishop").getClass());
        assertEquals(PieceType.PAWN.create().getClass(), Chessboard.parsePiece("Pawn").getClass());

    }

    @Test
    @DisplayName("When Invalid input piece is given. expected Fail")
    public void whenInvalidInputPieceThenShouldFail() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> Chessboard.parsePiece("Kingg"));
    }
